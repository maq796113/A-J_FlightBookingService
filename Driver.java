...
public class Driver {
  ...
  static String[] departureTimes = {
    "12:45",
    "01:45",
    "04:00"
  };
  static String[] availableDates = {
    "29/08/2023",
    "30/08/2023",
    "31/08/2023"
  };
        ...
        try {
          if (signIn.isUserValid()) {
            ...
            if (flight.getFlightClass().checkAvailability(as)) {
              ...
              System.out.println("\nBefore we proceed we need to get the Passenger's details.");
              System.out.print("Enter Passenger's Name: ");
              String name = scan.nextLine();
              System.out.print("\nEnter Passenger's CNIC: ");
              int cnic = scan.nextInt();
              System.out.print("\nEnter Passenger's Contact Number: ");
  ...
  private static void getDestandStart() {
    ...
    char[] is = takeInputsDestandStart();
  ...
  private static char[] takeInputsDestandStart() {
    char start_i;
    char dest_i;
